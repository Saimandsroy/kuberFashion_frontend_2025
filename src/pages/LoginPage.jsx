        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[#047BD2] focus:border-[#047BD2] sm:text-sm"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="appearance-none block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-[#047BD2] focus:border-[#047BD2] sm:text-sm"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#047BD2] focus:ring-[#047BD2] border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link
                  to="/forgot-password"
                  className="font-medium text-[#047BD2] hover:text-[#0369A1]"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="font-medium text-[#047BD2] hover:text-[#0369A1] underline">
                Sign up for free
              </Link>
            </p>
          </div>
